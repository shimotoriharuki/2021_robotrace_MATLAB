clf
clear
motor_distance_origin = load("COURSLOG/TOTALDIS.TXT");
pulley_distance_origin = load("COURSLOG/TOTALDISCENTER.txt");

motor_distance2_origin = load("COURSLOG/TOTALDIS2.TXT");
pulley_distance2_origin = load("COURSLOG/TOTALDISCENTER2.TXT");
