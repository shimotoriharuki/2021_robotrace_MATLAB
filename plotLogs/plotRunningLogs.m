...
third_run_sideline_distances = load('workingDirectory/third_run_sideline_distances.txt');
...
fourth_run_sideline_distances = load('workingDirectory/fourth_run_sideline_distances.txt');
...
fifth_run_sideline_distances = load('workingDirectory/fifth_run_sideline_distances.txt');
...
subplot(2, 2, 2);
plotVelocityTable(third_velocity_table);
title('Third Velocity tabele')

subplot(2, 2, 3);
plotVelocityTable(fourth_velocity_table);
title('Fourth Velocity tabele')

subplot(2, 2, 4);
plotVelocityTable(fifth_velocity_table);
